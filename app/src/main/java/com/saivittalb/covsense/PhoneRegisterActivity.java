...
public class PhoneRegisterActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText mFormatPhoneNumberField = findViewById(R.id.formatPhoneNumber);
        ccp.registerCarrierNumberEditText(mFormatPhoneNumberField);
        ccp.setPhoneNumberValidityChangeListener(isValidNumber -> mSelectedCountryCode = ccp.getSelectedCountryCodeWithPlus());
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(@NonNull String verificationId,
                ...
                // Update UI
                Toast.makeText(PhoneRegisterActivity.this, "OTP Sent", Toast.LENGTH_SHORT).show();
    ...
    public void onStart() {
        ...
        if (mVerificationInProgress && validatePhoneNumber()) {
            startPhoneNumberVerification(mSelectedCountryCode + mPhoneNumberField.getEditText().getText().toString());
        }
    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            final String phoneNumber = mSelectedCountryCode + mPhoneNumberField.getEditText().getText().toString();
    ...
    private boolean validatePhoneNumber() {
        ...
        Log.d("CCP", "Country Code : " + mSelectedCountryCode);
        Log.d("Phone", "Phone Number : " + mPhoneNumberField.getEditText().getText().toString());
        Log.d("Phone", "Unformatted Phone Number with prefix : " + ccp.getFullNumberWithPlus());
        return true;
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.buttonResend:
                resendVerificationCode(mSelectedCountryCode + mPhoneNumberField.getEditText().getText().toString(), mResendToken);
                break;
        }
    }
}
